...
def create_snapshot(database: Database, book_id: str) -> dict[str, object]:
    ...
    workspace_book = _workspace_for_book(database, book_id)
    snapshots_dir = workspace_book / "snapshots"
